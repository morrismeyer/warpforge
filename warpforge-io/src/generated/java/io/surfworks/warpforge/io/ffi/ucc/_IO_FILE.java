...
public class _IO_FILE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Ucc.C_INT.withName("_flags"),
        MemoryLayout.paddingLayout(4),
        Ucc.C_POINTER.withName("_IO_read_ptr"),
        Ucc.C_POINTER.withName("_IO_read_end"),
        Ucc.C_POINTER.withName("_IO_read_base"),
        Ucc.C_POINTER.withName("_IO_write_base"),
        Ucc.C_POINTER.withName("_IO_write_ptr"),
        Ucc.C_POINTER.withName("_IO_write_end"),
        Ucc.C_POINTER.withName("_IO_buf_base"),
        Ucc.C_POINTER.withName("_IO_buf_end"),
        Ucc.C_POINTER.withName("_IO_save_base"),
        Ucc.C_POINTER.withName("_IO_backup_base"),
        Ucc.C_POINTER.withName("_IO_save_end"),
        Ucc.C_POINTER.withName("_markers"),
        Ucc.C_POINTER.withName("_chain"),
        Ucc.C_INT.withName("_fileno"),
        Ucc.C_INT.withName("_flags2"),
        Ucc.C_LONG.withName("_old_offset"),
        Ucc.C_SHORT.withName("_cur_column"),
        Ucc.C_CHAR.withName("_vtable_offset"),
        MemoryLayout.sequenceLayout(1, Ucc.C_CHAR).withName("_shortbuf"),
        MemoryLayout.paddingLayout(4),
        Ucc.C_POINTER.withName("_lock"),
        Ucc.C_LONG.withName("_offset"),
        Ucc.C_POINTER.withName("_codecvt"),
        Ucc.C_POINTER.withName("_wide_data"),
        Ucc.C_POINTER.withName("_freeres_list"),
        Ucc.C_POINTER.withName("_freeres_buf"),
        Ucc.C_LONG.withName("__pad5"),
        Ucc.C_INT.withName("_mode"),
        MemoryLayout.sequenceLayout(20, Ucc.C_CHAR).withName("_unused2")
    ).withName("_IO_FILE");
