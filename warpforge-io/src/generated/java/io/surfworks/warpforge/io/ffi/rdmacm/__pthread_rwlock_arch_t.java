...
public class __pthread_rwlock_arch_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        RdmaCm.C_INT.withName("__readers"),
        RdmaCm.C_INT.withName("__writers"),
        RdmaCm.C_INT.withName("__wrphase_futex"),
        RdmaCm.C_INT.withName("__writers_futex"),
        RdmaCm.C_INT.withName("__pad3"),
        RdmaCm.C_INT.withName("__pad4"),
        RdmaCm.C_INT.withName("__cur_writer"),
        RdmaCm.C_INT.withName("__shared"),
        RdmaCm.C_CHAR.withName("__rwelision"),
        MemoryLayout.sequenceLayout(7, RdmaCm.C_CHAR).withName("__pad1"),
        RdmaCm.C_LONG.withName("__pad2"),
        RdmaCm.C_INT.withName("__flags"),
