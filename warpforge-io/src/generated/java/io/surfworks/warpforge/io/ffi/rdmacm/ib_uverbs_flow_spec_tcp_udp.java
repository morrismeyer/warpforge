 ...
 * }
 */
public class ib_uverbs_flow_spec_tcp_udp {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        ib_uverbs_flow_tcp_udp_filter.layout().withName("val"),
        ib_uverbs_flow_tcp_udp_filter.layout().withName("mask")
    ).withName("ib_uverbs_flow_spec_tcp_udp");
    ...
    private static final GroupLayout hdr$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$956:2"), groupElement("hdr"));
    ...
    private static final OfInt type$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$956:2"), groupElement("$anon$958:3"), groupElement("type"));
    ...
    private static final OfShort size$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$956:2"), groupElement("$anon$958:3"), groupElement("size"));
    ...
    private static final OfShort reserved$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$956:2"), groupElement("$anon$958:3"), groupElement("reserved"));
