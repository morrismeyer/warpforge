...
public class tm {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        RdmaCm.C_INT.withName("tm_sec"),
        RdmaCm.C_INT.withName("tm_min"),
        RdmaCm.C_INT.withName("tm_hour"),
        RdmaCm.C_INT.withName("tm_mday"),
        RdmaCm.C_INT.withName("tm_mon"),
        RdmaCm.C_INT.withName("tm_year"),
        RdmaCm.C_INT.withName("tm_wday"),
        RdmaCm.C_INT.withName("tm_yday"),
        RdmaCm.C_INT.withName("tm_isdst"),
        MemoryLayout.paddingLayout(4),
        RdmaCm.C_LONG.withName("tm_gmtoff"),
        RdmaCm.C_POINTER.withName("tm_zone")
    ).withName("tm");
