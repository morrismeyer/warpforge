...
public class __pthread_cleanup_frame {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Ibverbs.C_POINTER.withName("__cancel_routine"),
        Ibverbs.C_POINTER.withName("__cancel_arg"),
        Ibverbs.C_INT.withName("__do_it"),
        Ibverbs.C_INT.withName("__cancel_type")
     ...
     * }
     */
    public static class __cancel_routine {
        ...
        private static final MethodHandle UP$MH = Ibverbs.upcallHandle(__cancel_routine.Function.class, "apply", $DESC);
