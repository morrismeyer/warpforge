...
public class __pthread_cleanup_frame {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        RdmaCm.C_POINTER.withName("__cancel_routine"),
        RdmaCm.C_POINTER.withName("__cancel_arg"),
        RdmaCm.C_INT.withName("__do_it"),
        RdmaCm.C_INT.withName("__cancel_type")
    ...
    public static class __cancel_routine {
        ...
        private static final MethodHandle UP$MH = RdmaCm.upcallHandle(__cancel_routine.Function.class, "apply", $DESC);
