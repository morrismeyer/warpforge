...
public class _IO_FILE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Ucx.C_INT.withName("_flags"),
        MemoryLayout.paddingLayout(4),
        Ucx.C_POINTER.withName("_IO_read_ptr"),
        Ucx.C_POINTER.withName("_IO_read_end"),
        Ucx.C_POINTER.withName("_IO_read_base"),
        Ucx.C_POINTER.withName("_IO_write_base"),
        Ucx.C_POINTER.withName("_IO_write_ptr"),
        Ucx.C_POINTER.withName("_IO_write_end"),
        Ucx.C_POINTER.withName("_IO_buf_base"),
        Ucx.C_POINTER.withName("_IO_buf_end"),
        Ucx.C_POINTER.withName("_IO_save_base"),
        Ucx.C_POINTER.withName("_IO_backup_base"),
        Ucx.C_POINTER.withName("_IO_save_end"),
        Ucx.C_POINTER.withName("_markers"),
        Ucx.C_POINTER.withName("_chain"),
        Ucx.C_INT.withName("_fileno"),
        Ucx.C_INT.withName("_flags2"),
        Ucx.C_LONG.withName("_old_offset"),
        Ucx.C_SHORT.withName("_cur_column"),
        Ucx.C_CHAR.withName("_vtable_offset"),
        MemoryLayout.sequenceLayout(1, Ucx.C_CHAR).withName("_shortbuf"),
        MemoryLayout.paddingLayout(4),
        Ucx.C_POINTER.withName("_lock"),
        Ucx.C_LONG.withName("_offset"),
        Ucx.C_POINTER.withName("_codecvt"),
        Ucx.C_POINTER.withName("_wide_data"),
        Ucx.C_POINTER.withName("_freeres_list"),
        Ucx.C_POINTER.withName("_freeres_buf"),
        Ucx.C_LONG.withName("__pad5"),
        Ucx.C_INT.withName("_mode"),
        MemoryLayout.sequenceLayout(20, Ucx.C_CHAR).withName("_unused2")
    ).withName("_IO_FILE");
