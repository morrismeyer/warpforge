...
public class in6_addr {
    ...
    public static class __in6_u {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            MemoryLayout.sequenceLayout(16, RdmaCm.C_CHAR).withName("__u6_addr8"),
            MemoryLayout.sequenceLayout(8, RdmaCm.C_SHORT).withName("__u6_addr16"),
            MemoryLayout.sequenceLayout(4, RdmaCm.C_INT).withName("__u6_addr32")
        ).withName("$anon$221:5");
