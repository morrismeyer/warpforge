...
public class cmsghdr {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        RdmaCm.C_LONG.withName("cmsg_len"),
        RdmaCm.C_INT.withName("cmsg_level"),
        RdmaCm.C_INT.withName("cmsg_type"),
        MemoryLayout.sequenceLayout(0, RdmaCm.C_CHAR).withName("__cmsg_data")
    ).withName("cmsghdr");
