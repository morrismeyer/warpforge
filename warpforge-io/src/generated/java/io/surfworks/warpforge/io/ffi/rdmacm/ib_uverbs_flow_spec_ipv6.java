 ...
 * }
 */
public class ib_uverbs_flow_spec_ipv6 {

    ib_uverbs_flow_spec_ipv6() {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        ib_uverbs_flow_ipv6_filter.layout().withName("val"),
        ib_uverbs_flow_ipv6_filter.layout().withName("mask")
    ).withName("ib_uverbs_flow_spec_ipv6");
    ...
    private static final GroupLayout hdr$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$979:2"), groupElement("hdr"));
    ...
    private static final OfInt type$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$979:2"), groupElement("$anon$981:3"), groupElement("type"));
    ...
    private static final OfShort size$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$979:2"), groupElement("$anon$981:3"), groupElement("size"));
    ...
    private static final OfShort reserved$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$979:2"), groupElement("$anon$981:3"), groupElement("reserved"));
