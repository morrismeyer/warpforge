...
public class _pthread_cleanup_buffer {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        RdmaCm.C_POINTER.withName("__routine"),
        RdmaCm.C_POINTER.withName("__arg"),
        RdmaCm.C_INT.withName("__canceltype"),
        MemoryLayout.paddingLayout(4),
        RdmaCm.C_POINTER.withName("__prev")
    ...
    public static class __routine {
        ...
        private static final MethodHandle UP$MH = RdmaCm.upcallHandle(__routine.Function.class, "apply", $DESC);
