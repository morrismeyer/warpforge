...
/**
 * CUDA kernel implementation for stablehlo.multiply operation.
 *
 * <p>This kernel performs element-wise multiplication of two float32 tensors on the GPU.
 ...
 * </ul>
 *
 * @see CudaKernels#generateMultiplyF32(int)
 */
public final class MultiplyKernel implements CudaOpKernel {
    ...
    /**
     * Create a Multiply kernel with no instrumentation.
     */
    public MultiplyKernel(CudaContext context) {
        this(context, CudaKernels.SALT_NONE);
    }

    /**
     * Create a Multiply kernel with the specified instrumentation level.
     *
     * @param context CUDA context for execution
     * @param salt Instrumentation level (SALT_NONE, SALT_TIMING, SALT_TRACE)
     */
    public MultiplyKernel(CudaContext context, int salt) {
    ...
    private synchronized void ensureInitialized() {
        ...
        String ptxSource = CudaKernels.generateMultiplyF32(salt);
