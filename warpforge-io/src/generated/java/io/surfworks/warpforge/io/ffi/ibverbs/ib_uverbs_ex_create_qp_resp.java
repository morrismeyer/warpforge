 ...
 * }
 */
public class ib_uverbs_ex_create_qp_resp {

    ib_uverbs_ex_create_qp_resp() {
        // Should not be called directly
    }

    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ib_uverbs_create_qp_resp.layout().withName("base"),
        Ibverbs.C_INT.withName("comp_mask"),
        Ibverbs.C_INT.withName("response_length")
    ).withName("ib_uverbs_ex_create_qp_resp");
    ...
    private static final long comp_mask$OFFSET = 32;
    ...
    private static final long response_length$OFFSET = 36;
