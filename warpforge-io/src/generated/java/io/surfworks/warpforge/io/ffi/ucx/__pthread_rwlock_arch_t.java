...
public class __pthread_rwlock_arch_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Ucx.C_INT.withName("__readers"),
        Ucx.C_INT.withName("__writers"),
        Ucx.C_INT.withName("__wrphase_futex"),
        Ucx.C_INT.withName("__writers_futex"),
        Ucx.C_INT.withName("__pad3"),
        Ucx.C_INT.withName("__pad4"),
        Ucx.C_INT.withName("__cur_writer"),
        Ucx.C_INT.withName("__shared"),
        Ucx.C_CHAR.withName("__rwelision"),
        MemoryLayout.sequenceLayout(7, Ucx.C_CHAR).withName("__pad1"),
        Ucx.C_LONG.withName("__pad2"),
        Ucx.C_INT.withName("__flags"),
