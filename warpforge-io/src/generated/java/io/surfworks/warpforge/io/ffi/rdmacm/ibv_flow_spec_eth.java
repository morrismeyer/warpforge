 ...
 * }
 */
public class ibv_flow_spec_eth {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        ibv_flow_eth_filter.layout().withName("val"),
        ibv_flow_eth_filter.layout().withName("mask"),
        MemoryLayout.paddingLayout(2)
    ).withName("ibv_flow_spec_eth");
    ...
    private static final long mask$OFFSET = 22;
