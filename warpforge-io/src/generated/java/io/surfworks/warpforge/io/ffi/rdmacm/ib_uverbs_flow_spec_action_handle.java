 ...
 * }
 */
public class ib_uverbs_flow_spec_action_handle {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.unionLayout(
            ...
            ).withName("$anon$1018:3")
        ).withName("$anon$1016:2"),
        RdmaCm.C_INT.withName("handle"),
        RdmaCm.C_INT.withName("reserved1")
    ).withName("ib_uverbs_flow_spec_action_handle");
    ...
    private static final GroupLayout hdr$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$1016:2"), groupElement("hdr"));
    ...
    private static final OfInt type$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1016:2"), groupElement("$anon$1018:3"), groupElement("type"));
    ...
    private static final OfShort size$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$1016:2"), groupElement("$anon$1018:3"), groupElement("size"));
    ...
    private static final OfShort reserved$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$1016:2"), groupElement("$anon$1018:3"), groupElement("reserved"));
