 ...
 * }
 */
public class ibv_flow_spec_ipv4_ext {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        ibv_flow_ipv4_ext_filter.layout().withName("val"),
        ibv_flow_ipv4_ext_filter.layout().withName("mask")
    ).withName("ibv_flow_spec_ipv4_ext");
