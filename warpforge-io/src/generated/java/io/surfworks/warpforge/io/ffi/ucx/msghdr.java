...
public class msghdr {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Ucx.C_POINTER.withName("msg_name"),
        Ucx.C_INT.withName("msg_namelen"),
        MemoryLayout.paddingLayout(4),
        Ucx.C_POINTER.withName("msg_iov"),
        Ucx.C_LONG.withName("msg_iovlen"),
        Ucx.C_POINTER.withName("msg_control"),
        Ucx.C_LONG.withName("msg_controllen"),
        Ucx.C_INT.withName("msg_flags"),
        MemoryLayout.paddingLayout(4)
    ).withName("msghdr");
