 ...
 * }
 */
public class rdma_cm_join_mc_attr_ex {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        RdmaCm.C_INT.withName("join_flags"),
        RdmaCm.C_POINTER.withName("addr")
    ).withName("rdma_cm_join_mc_attr_ex");
    ...
    private static final OfInt join_flags$LAYOUT = (OfInt)$LAYOUT.select(groupElement("join_flags"));
     ...
     * }
     */
    public static final OfInt join_flags$layout() {
        return join_flags$LAYOUT;
    }

    private static final long join_flags$OFFSET = 4;
     ...
     * }
     */
    public static final long join_flags$offset() {
        return join_flags$OFFSET;
    }
     ...
     * }
     */
    public static int join_flags(MemorySegment struct) {
        return struct.get(join_flags$LAYOUT, join_flags$OFFSET);
    }
     ...
     * }
     */
    public static void join_flags(MemorySegment struct, int fieldValue) {
        struct.set(join_flags$LAYOUT, join_flags$OFFSET, fieldValue);
    }
