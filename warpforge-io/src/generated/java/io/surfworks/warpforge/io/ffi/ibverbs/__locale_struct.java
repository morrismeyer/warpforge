...
public class __locale_struct {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(13, Ibverbs.C_POINTER).withName("__locales"),
        Ibverbs.C_POINTER.withName("__ctype_b"),
        Ibverbs.C_POINTER.withName("__ctype_tolower"),
        Ibverbs.C_POINTER.withName("__ctype_toupper"),
        MemoryLayout.sequenceLayout(13, Ibverbs.C_POINTER).withName("__names")
