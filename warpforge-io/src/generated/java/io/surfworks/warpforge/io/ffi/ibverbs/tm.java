...
public class tm {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Ibverbs.C_INT.withName("tm_sec"),
        Ibverbs.C_INT.withName("tm_min"),
        Ibverbs.C_INT.withName("tm_hour"),
        Ibverbs.C_INT.withName("tm_mday"),
        Ibverbs.C_INT.withName("tm_mon"),
        Ibverbs.C_INT.withName("tm_year"),
        Ibverbs.C_INT.withName("tm_wday"),
        Ibverbs.C_INT.withName("tm_yday"),
        Ibverbs.C_INT.withName("tm_isdst"),
        MemoryLayout.paddingLayout(4),
        Ibverbs.C_LONG.withName("tm_gmtoff"),
        Ibverbs.C_POINTER.withName("tm_zone")
    ).withName("tm");
