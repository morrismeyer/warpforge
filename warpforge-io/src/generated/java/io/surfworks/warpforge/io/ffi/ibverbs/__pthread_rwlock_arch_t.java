...
public class __pthread_rwlock_arch_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Ibverbs.C_INT.withName("__readers"),
        Ibverbs.C_INT.withName("__writers"),
        Ibverbs.C_INT.withName("__wrphase_futex"),
        Ibverbs.C_INT.withName("__writers_futex"),
        Ibverbs.C_INT.withName("__pad3"),
        Ibverbs.C_INT.withName("__pad4"),
        Ibverbs.C_INT.withName("__cur_writer"),
        Ibverbs.C_INT.withName("__shared"),
        Ibverbs.C_CHAR.withName("__rwelision"),
        MemoryLayout.sequenceLayout(7, Ibverbs.C_CHAR).withName("__pad1"),
        Ibverbs.C_LONG.withName("__pad2"),
        Ibverbs.C_INT.withName("__flags"),
