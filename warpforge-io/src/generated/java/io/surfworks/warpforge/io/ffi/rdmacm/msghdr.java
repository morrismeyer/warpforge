...
public class msghdr {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        RdmaCm.C_POINTER.withName("msg_name"),
        RdmaCm.C_INT.withName("msg_namelen"),
        MemoryLayout.paddingLayout(4),
        RdmaCm.C_POINTER.withName("msg_iov"),
        RdmaCm.C_LONG.withName("msg_iovlen"),
        RdmaCm.C_POINTER.withName("msg_control"),
        RdmaCm.C_LONG.withName("msg_controllen"),
        RdmaCm.C_INT.withName("msg_flags"),
        MemoryLayout.paddingLayout(4)
    ).withName("msghdr");
