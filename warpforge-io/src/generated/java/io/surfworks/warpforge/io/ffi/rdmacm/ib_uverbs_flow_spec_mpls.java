 ...
 * }
 */
public class ib_uverbs_flow_spec_mpls {

    ib_uverbs_flow_spec_mpls() {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.unionLayout(
            ...
            ).withName("$anon$1116:3")
        ).withName("$anon$1114:2"),
        ib_uverbs_flow_mpls_filter.layout().withName("val"),
        ib_uverbs_flow_mpls_filter.layout().withName("mask")
    ).withName("ib_uverbs_flow_spec_mpls");
    ...
    private static final GroupLayout hdr$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$1114:2"), groupElement("hdr"));
    ...
    private static final OfInt type$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1114:2"), groupElement("$anon$1116:3"), groupElement("type"));
    ...
    private static final OfShort size$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$1114:2"), groupElement("$anon$1116:3"), groupElement("size"));
    ...
    private static final OfShort reserved$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$1114:2"), groupElement("$anon$1116:3"), groupElement("reserved"));
