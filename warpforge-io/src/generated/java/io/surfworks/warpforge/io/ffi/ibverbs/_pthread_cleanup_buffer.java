...
public class _pthread_cleanup_buffer {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Ibverbs.C_POINTER.withName("__routine"),
        Ibverbs.C_POINTER.withName("__arg"),
        Ibverbs.C_INT.withName("__canceltype"),
        MemoryLayout.paddingLayout(4),
        Ibverbs.C_POINTER.withName("__prev")
    ...
    public static class __routine {
        ...
        private static final MethodHandle UP$MH = Ibverbs.upcallHandle(__routine.Function.class, "apply", $DESC);
